...
with open("c:/Users/girit/OneDrive/Documents/zorvyn-fintech/zorvyn-finance/zorvyn-finance/apps/api/micro_apps/dashboard/tests/test_service.py", "w") as f:
    f.write(dashboard_code)

print("Dashboard test updated.")
